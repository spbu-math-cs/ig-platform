            ...
            <div
                ...
                <h2 className="flex flex-col items-center justify-center space-y-6 text-2xl md:text-4xl font-bold">
                    {winner === "X"
                        ? <XIcon/>
                        : <OIcon/>}
                    <p className={`uppercase text-txt`}>Takes the Round</p>
                </h2>

                <div className="flex items-center justify-center space-x-16">
                    <button onClick={handleQuitGame}
                            className={`button px-4 rounded-md py-1 bg-quit hover:bg-panel hover:ring-4 hover:ring-gray-400`}>Quit
                    </button>
                    <button onClick={handleNewGame}
                            className={`button px-4 rounded-md py-1 bg-next hover:bg-panel hover:ring-4 hover:ring-cyan-300`}>Next
                        Round
                    </button>
                </div>
            </div>
